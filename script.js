...
function generatePassword() {
  var addLength = (prompt("How many characters would you like your password to be? (8 - 128 characters)."));
  ...
  alert("Your password length is going to be " + addLength + " characters.");
